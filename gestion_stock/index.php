...
<script>
    $(document).ready(function() {
        ...
        function fetch_data(is_date_search, start_date = '', end_date = '', region = '',  delegue = '') {
        ...
        $("#search").click(function() {
            ...
            var region = $('#region').is(":hidden") ? "<?php echo $region?>" : $('#region').val();
            var delegue = $('#delegue').val();
            console.log(start_date + " " + end_date +"  "+ region+"  "+delegue+" ");
            if (start_date != "" && end_date != "") {
                $('#report_table').DataTable().destroy();
                fetch_data('yes', start_date, end_date, region, delegue);
                <?php $_SESSION['referrer'] = "rpf.php"; ?>
                $("#export").css({
                    "display": "block"
                });
        ...
        $('#btn-export').click(function() {
            ...
            if (start_date != '' && end_date != '') {
                exportData(start_date, end_date, region, delegue);
                resetComponents();
            } else {
                alert("Both Date is Required");
            }
        ...
        function exportData(start_date, end_date, region, delegue = '') {
            if (start_date != '' && end_date != '') {
                console.log(start_date + " " + end_date)
                window.location.href = 'export_rpf.php?start_date=' + start_date + '&end_date=' + end_date + '&region=' + region + '&delegue=' + delegue;
            } else {
                alert("Both Date is Required");
            }
            console.log('export');
